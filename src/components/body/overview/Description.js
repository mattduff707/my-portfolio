...
const Description = () => {
  return (
    <DescriptionContainer>
      ...
      <DescriptionText>
        Passionate self taught developer who revels in c oasdo dosod asodoasod asd oasod aosdo aosod oasod oaosdo oasodo
        as Passionate self taught developer who revels in c oasdo dosod asodoasod asd oasod aosdo aosod oasod oaosdo
        oasodo as Passionate self taught asd asd asd asd asd asd asd s ad
      </DescriptionText>
    </DescriptionContainer>
  );
};
